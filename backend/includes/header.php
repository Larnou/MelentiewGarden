  ...
  <div class="header__container">
    ...
    <nav class="header__nav" id="site-nav" aria-label="Главное меню">
      <ul class="header__menu">
        ...
        <li class="header__item">
          <a class="header__link <?= $activePage === 'catalog' ? 'is-active' : '' ?>" href="/pages/catalog.php">Каталог</a>
        </li>
        <li class="header__item">
          <a class="header__link <?= $activePage === 'articles' ? 'is-active' : '' ?>" href="/pages/articles.php">Статьи</a>
        </li>
        <li class="header__item">
