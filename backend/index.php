                ...
                <div class="hero__container">
                    <div class="hero__content">
                        ...
                        <p class="hero__subtitle">
                            Мы выращиваем только проверенные урожайные сорта<br>адаптированные к сибирским морозам
                        </p>
                        <div class="hero__slider swiper js-hero-categories">
                            <div class="hero__slider-container swiper-wrapper">
                                <a class="hero__slider-slide swiper-slide" href="/pages/catalog.php?tag=seedling-seed">Семечковые</a>
                                <a class="hero__slider-slide swiper-slide" href="/pages/catalog.php?tag=seedling-stone">Косточковые</a>
                                <a class="hero__slider-slide swiper-slide" href="/pages/catalog.php?tag=seedling-berry">Ягодные</a>
                                <a class="hero__slider-slide swiper-slide" href="/pages/catalog.php?tag=seedling-decor">Декоративные</a>
                                <a class="hero__slider-slide swiper-slide" href="/pages/catalog.php?tag=seedling-indoor">Комнатные</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="fair__container">
                    ...
                    <div class="fair__card">
                        <div class="fair__image-wrapper">
                            <img class="fair__image" src="/assets/img/pages/exposition_banner.jpg" alt="Фотографии ярмарок">
                        </div>
                ...
                <div class="seedlings__container">
                    ...
                    <div class="seedlings__slider swiper js-seedlings-slider">
                        <div class="seedlings__list swiper-wrapper">
                            <a class="seedlings-card swiper-slide" href="/pages/catalog/flamingo.php">
                                <img class="seedlings-card__image" src="/assets/img/pages/catalog/flamingo/fl-1.jpg" alt="Яблоня сорт Фламинго">
                            ...
                            <a class="seedlings-card swiper-slide" href="/pages/catalog/podarok-sadovodam.php">
                                <img class="seedlings-card__image" src="/assets/img/pages/catalog/podarok-sadovodam/ps-1.jpg" alt="Яблоня сорт Подарок садоводам">
                                <h3 class="seedlings-card__title">ЯБЛОНЯ</h3>
                                <p class="seedlings-card__subtitle">Подарок садоводам · осенний сорт</p>
                                <p class="seedlings-card__price">от 800 ₽</p>
                            </a>
                            <a class="seedlings-card swiper-slide" href="/pages/catalog/altayskoye-nalivnoye.php">
                                <img class="seedlings-card__image" src="/assets/img/pages/catalog/altayskoye-nalivnoye/an-2.jpg" alt="Яблоня сорт Алтайское наливное">
                                <h3 class="seedlings-card__title">ЯБЛОНЯ</h3>
                                <p class="seedlings-card__subtitle">Алтайское наливное · летний сорт</p>
                                <p class="seedlings-card__price">от 800 ₽</p>
                            </a>
                        </div>
                    </div>
                    <div class="seedlings__controls">
                        <button class="seedlings__arrow seedlings__arrow--prev" type="button" aria-label="Предыдущие саженцы">
                            <span>◀</span>
                        </button>
                        <a class="seedlings__more-button" href="/pages/catalog.php">Посмотреть больше</a>
                        <button class="seedlings__arrow seedlings__arrow--next" type="button" aria-label="Следующие саженцы">
                            <span>▶</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="articles__container">
                    ...
                    <div class="articles__slider swiper js-articles-slider">
                        <div class="articles__list swiper-wrapper">
                            <a class="article-card swiper-slide" href="/pages/articles/pravila-posadki-sadovoy-zemlyaniki.php" data-tags="care">
                                <img class="article-card__image" src="/assets/img/pages/articles/pravila-posadki-sadovoy-zemlyaniki/sajenci.png" alt="Правила посадки садовой земляники">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/zonirovanie.php" data-tags="care">
                                <img class="article-card__image" src="/assets/img/pages/articles/zonirovanie/zones.png" alt="Микроклиматическое зонирование сада">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/opylenie.php" data-tags="apple">
                                <img class="article-card__image" src="/assets/img/pages/articles/opylenie/opilenie.png" alt="Опыление яблони и груши">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/sakura.php" data-tags="care">
                                <img class="article-card__image" src="/assets/img/pages/articles/sakura/sakura.jpg" alt="Розовое весеннее цветение в саду">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/belit-stvoly-derevev.php" data-tags="apple care">
                                <img class="article-card__image" src="/assets/img/pages/articles/belit-stvoly-derevev/stvol.png" alt="Стволы яблонь: побелка и уход">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/posadka-sazhencev.php" data-tags="apple care">
                                <img class="article-card__image" src="/assets/img/pages/articles/posadka-sazhencev/posadka.jpg" alt="Посадка саженца плодового дерева">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/podgotovka-maliny-k-zime.php" data-tags="care">
                                <img class="article-card__image" src="/assets/img/pages/articles/podgotovka-maliny-k-zime/podgotovka.jpg" alt="Малина: подготовка к зиме">
                            ...
                            <a class="article-card swiper-slide" href="/pages/articles/sosedi.php" data-tags="care">
                                <img class="article-card__image" src="/assets/img/pages/articles/sosedi/sosedi.jpg" alt="Совместимые кустарники в саду">
                ...
                <div class="history__container">
                    ...
                    <div class="history__content">
                        <div class="history__image-wrapper">
                            <img class="history__image" src="/assets/img/pages/Lyudmila_Mikhailovna.jpg" alt="Людмила Михайловна в саду">
                        </div>
