<?php
$pageTitle = 'Яблоня · Подарок садоводам';
$pageDescription = 'Осенний сорт яблони Подарок садоводам: плоды до 80 г, жёлтые с красным штриховым румянцем, зимостойкость, селекция Т.Ф. Корниенко (Барнаул).';
$activePage = 'catalog';
?>
...
<section class="article article--product">
            <div class="article__container"><a class="article__back" href="/pages/catalog.php">← Назад к каталогу</a>
                <h1 class="article__title">Яблоня · Подарок садоводам</h1>
                ...
                <div class="article-block article-block--list article-block--list-unordered">
                    <ul class="article-block__list">
                        <li>Плоды крупные, массой до 80 г, жёлтые с красным штриховым румянцем. Мякоть сочная, мелкозернистая.</li>
                        <li>Созревают в середине сентября, хранятся до января.</li>
                        <li>Дерево среднерослое.</li>
                        <li>Сорт зимостойкий, плодоносит ежегодно.</li>
                    </ul>
                </div>
                ...
                <div class="article-block article-block--slider-captions">
                    <div class="article-block__slider swiper js-article-gallery-captions">
                        <div class="article-block__slider-wrapper swiper-wrapper">
                            ...
                            <div class="article-block__slide swiper-slide"><img src="/assets/img/pages/catalog/podarok-sadovodam/ps-3.jpg" alt="Плоды">
                                <p class="article-block__slide-caption"></p>
                            </div>
                        </div>
                    </div>
